...
const Hero = () => {
  return (
    <div className="">
      <div className="bg-red-500  dark:bg-[#232323] flex relative z-20 items-center overflow-hidden ">
        <div className="container mx-auto flex relative py-16 w-10/12 ">
          <div className="flex w-full md:space-x-36 space-x-0">
            ...
            <div className="sm:w-6/12 lg:w-5/12 flex flex-col relative z-20 p-6">
              ...
              <h1 className="font-bebas-neue uppercase text-6xl sm:text-8xl font-black flex flex-col leading-none dark:text-white text-[#232323] ">
                Indulge in
                <span className="text-5xl sm:text-7xl">Luxury</span>
              </h1>
              <p className="text-sm sm:text-base text-[#232323] dark:text-white mt-5">
