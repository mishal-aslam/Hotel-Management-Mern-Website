    ...
    <div className="bg-[#232323] border-t border-gray-200">
      <div className="max-w-screen-lg md:py-10 py-5 px-4 sm:px-6 text-gray-800 sm:flex justify-between mx-auto">
        <div className="p-5 sm:w-2/12 border-r ">
          ...
          <ul>
            <li className="my-2">
              <a className="dark:text-white text-[#232323]" href="#">
                Home
              </a>
            </li>
            <li className="my-2">
        ...
        <div className="p-5 sm:w-7/12 border-r md:text-center">
          ...
          <p className="dark:text-white text-[#232323] text-md mb-10 mt-10">
      ...
      <div className="flex pt-5 pb-1 px-3 m-auto text-gray-800 text-2xl flex-col items-center border-t max-w-screen-xl">
        <div className="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
          <a
            ...
            className="w-6 mx-1 dark:text-white text-[#232323] hover:text-red-600"
          >
            <AiFillGithub />
          </a>
          <a
      ...
      <div className="text-center dark:text-white text-[#232323] -space-y-3">
